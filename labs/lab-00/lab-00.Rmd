...
```{r setup-tibble}
usernames <- c("wilsonamy", "kirstenodonoghue", "nwexelstein", "hrissyy", "username") #Extend if necessary
nums <- c(18, 18, 1, 18, 9) #Extend if necessary
colours <- c("powderblue", "peachpuff3", "seagreen4", "red1", "yellow1") #Extend if necessary
