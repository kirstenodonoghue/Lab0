...
```{r setup-tibble}
usernames <- c("wilsonamy", "kirstenodonoghue", "nwexelstein", "hrissyy", "username 4") #Extend if necessary
nums <- c(18, 18, 1, 18, NA) #Extend if necessary
colours <- c("powderblue", "peachpuff3", "seagreen4", "red1", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Running", "Reading", "Sleeping", "Hobby 4") #Extend if necessary
